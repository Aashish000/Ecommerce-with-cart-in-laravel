                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="gender" class="form-control" name="gender" value="{{ old('gender') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="state" class="form-control" name="state" value="{{ old('state') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('postal_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="postal_code" class="form-control" name="postal_code" value="{{ old('postal_code') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="country" class="form-control" name="country" value="{{ old('country') }}" required>
